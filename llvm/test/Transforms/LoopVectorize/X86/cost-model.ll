...
; CHECK-NEXT:    [[TMP20:%.*]] = select i1 [[TMP19]], i64 16, i64 [[N_MOD_VF]]
...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <16 x i64>, ptr [[TMP25]], align 8, !alias.scope [[META9:![0-9]+]]
; CHECK-NEXT:    [[TMP26:%.*]] = icmp eq <16 x i64> [[WIDE_LOAD]], zeroinitializer
; CHECK-NEXT:    [[TMP27:%.*]] = and <16 x i1> [[BROADCAST_SPLAT]], [[TMP26]]
; CHECK-NEXT:    [[TMP28:%.*]] = zext <16 x i1> [[TMP27]] to <16 x i8>
; CHECK-NEXT:    [[TMP29:%.*]] = extractelement <16 x i8> [[TMP28]], i64 15
...
; CHECK:       [[VECTOR_PH]]:
; CHECK-NEXT:    [[MIN_ITERS_CHECK3:%.*]] = icmp ule i64 [[TMP2]], 32
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK3]], label %[[VEC_EPILOG_PH:.*]], label %[[VECTOR_PH1:.*]]
; CHECK:       [[VECTOR_PH1]]:
; CHECK-NEXT:    [[N_MOD_VF1:%.*]] = urem i64 [[TMP2]], 32
; CHECK-NEXT:    [[TMP143:%.*]] = icmp eq i64 [[N_MOD_VF1]], 0
; CHECK-NEXT:    [[TMP144:%.*]] = select i1 [[TMP143]], i64 32, i64 [[N_MOD_VF1]]
; CHECK-NEXT:    [[N_VEC1:%.*]] = sub i64 [[TMP2]], [[TMP144]]
; CHECK-NEXT:    [[TMP145:%.*]] = mul i64 [[N_VEC1]], 40
; CHECK-NEXT:    [[TMP146:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP145]]
; CHECK-NEXT:    br label %[[VECTOR_BODY1:.*]]
; CHECK:       [[VECTOR_BODY1]]:
; CHECK-NEXT:    [[INDEX1:%.*]] = phi i64 [ 0, %[[VECTOR_PH1]] ], [ [[INDEX_NEXT1:%.*]], %[[VECTOR_BODY1]] ]
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <16 x i1> [ zeroinitializer, %[[VECTOR_PH1]] ], [ [[TMP137:%.*]], %[[VECTOR_BODY1]] ]
; CHECK-NEXT:    [[VEC_PHI4:%.*]] = phi <16 x i1> [ zeroinitializer, %[[VECTOR_PH1]] ], [ [[TMP138:%.*]], %[[VECTOR_BODY1]] ]
; CHECK-NEXT:    [[TMP147:%.*]] = mul i64 [[INDEX1]], 40
; CHECK-NEXT:    [[TMP148:%.*]] = add i64 [[TMP147]], 40
; CHECK-NEXT:    [[TMP149:%.*]] = add i64 [[TMP147]], 80
; CHECK-NEXT:    [[TMP150:%.*]] = add i64 [[TMP147]], 120
; CHECK-NEXT:    [[TMP151:%.*]] = add i64 [[TMP147]], 160
; CHECK-NEXT:    [[TMP152:%.*]] = add i64 [[TMP147]], 200
; CHECK-NEXT:    [[TMP153:%.*]] = add i64 [[TMP147]], 240
; CHECK-NEXT:    [[TMP154:%.*]] = add i64 [[TMP147]], 280
; CHECK-NEXT:    [[TMP155:%.*]] = add i64 [[TMP147]], 320
; CHECK-NEXT:    [[TMP156:%.*]] = add i64 [[TMP147]], 360
; CHECK-NEXT:    [[TMP17:%.*]] = add i64 [[TMP147]], 400
; CHECK-NEXT:    [[TMP18:%.*]] = add i64 [[TMP147]], 440
; CHECK-NEXT:    [[TMP157:%.*]] = add i64 [[TMP147]], 480
; CHECK-NEXT:    [[TMP158:%.*]] = add i64 [[TMP147]], 520
; CHECK-NEXT:    [[TMP21:%.*]] = add i64 [[TMP147]], 560
; CHECK-NEXT:    [[TMP22:%.*]] = add i64 [[TMP147]], 600
; CHECK-NEXT:    [[TMP23:%.*]] = add i64 [[TMP147]], 640
; CHECK-NEXT:    [[TMP24:%.*]] = add i64 [[TMP147]], 680
; CHECK-NEXT:    [[TMP25:%.*]] = add i64 [[TMP147]], 720
; CHECK-NEXT:    [[TMP26:%.*]] = add i64 [[TMP147]], 760
; CHECK-NEXT:    [[TMP165:%.*]] = add i64 [[TMP147]], 800
; CHECK-NEXT:    [[TMP166:%.*]] = add i64 [[TMP147]], 840
; CHECK-NEXT:    [[TMP167:%.*]] = add i64 [[TMP147]], 880
; CHECK-NEXT:    [[TMP30:%.*]] = add i64 [[TMP147]], 920
; CHECK-NEXT:    [[TMP31:%.*]] = add i64 [[TMP147]], 960
; CHECK-NEXT:    [[TMP32:%.*]] = add i64 [[TMP147]], 1000
; CHECK-NEXT:    [[TMP33:%.*]] = add i64 [[TMP147]], 1040
; CHECK-NEXT:    [[TMP34:%.*]] = add i64 [[TMP147]], 1080
; CHECK-NEXT:    [[TMP35:%.*]] = add i64 [[TMP147]], 1120
; CHECK-NEXT:    [[TMP36:%.*]] = add i64 [[TMP147]], 1160
; CHECK-NEXT:    [[TMP37:%.*]] = add i64 [[TMP147]], 1200
; CHECK-NEXT:    [[TMP38:%.*]] = add i64 [[TMP147]], 1240
; CHECK-NEXT:    [[NEXT_GEP1:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP147]]
; CHECK-NEXT:    [[NEXT_GEP36:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP148]]
; CHECK-NEXT:    [[NEXT_GEP37:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP149]]
; CHECK-NEXT:    [[NEXT_GEP7:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP150]]
; CHECK-NEXT:    [[NEXT_GEP8:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP151]]
; CHECK-NEXT:    [[NEXT_GEP9:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP152]]
; CHECK-NEXT:    [[NEXT_GEP10:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP153]]
; CHECK-NEXT:    [[NEXT_GEP11:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP154]]
; CHECK-NEXT:    [[NEXT_GEP12:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP155]]
; CHECK-NEXT:    [[NEXT_GEP13:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP156]]
; CHECK-NEXT:    [[NEXT_GEP14:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP17]]
; CHECK-NEXT:    [[NEXT_GEP15:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP18]]
; CHECK-NEXT:    [[NEXT_GEP16:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP157]]
; CHECK-NEXT:    [[NEXT_GEP17:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP158]]
; CHECK-NEXT:    [[NEXT_GEP18:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP21]]
; CHECK-NEXT:    [[NEXT_GEP19:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP22]]
; CHECK-NEXT:    [[NEXT_GEP20:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP23]]
; CHECK-NEXT:    [[NEXT_GEP21:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP24]]
; CHECK-NEXT:    [[NEXT_GEP22:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP25]]
; CHECK-NEXT:    [[NEXT_GEP23:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP26]]
; CHECK-NEXT:    [[NEXT_GEP24:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP165]]
; CHECK-NEXT:    [[NEXT_GEP25:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP166]]
; CHECK-NEXT:    [[NEXT_GEP26:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP167]]
; CHECK-NEXT:    [[NEXT_GEP27:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP30]]
; CHECK-NEXT:    [[NEXT_GEP28:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP31]]
; CHECK-NEXT:    [[NEXT_GEP29:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP32]]
; CHECK-NEXT:    [[NEXT_GEP30:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP33]]
; CHECK-NEXT:    [[NEXT_GEP31:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP34]]
; CHECK-NEXT:    [[NEXT_GEP32:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP35]]
; CHECK-NEXT:    [[NEXT_GEP33:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP36]]
; CHECK-NEXT:    [[NEXT_GEP34:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP37]]
; CHECK-NEXT:    [[NEXT_GEP35:%.*]] = getelementptr i8, ptr [[START]], i64 [[TMP38]]
; CHECK-NEXT:    [[TMP39:%.*]] = getelementptr i8, ptr [[NEXT_GEP1]], i64 8
; CHECK-NEXT:    [[TMP40:%.*]] = getelementptr i8, ptr [[NEXT_GEP36]], i64 8
; CHECK-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr [[NEXT_GEP37]], i64 8
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr i8, ptr [[NEXT_GEP7]], i64 8
; CHECK-NEXT:    [[TMP43:%.*]] = getelementptr i8, ptr [[NEXT_GEP8]], i64 8
; CHECK-NEXT:    [[TMP44:%.*]] = getelementptr i8, ptr [[NEXT_GEP9]], i64 8
; CHECK-NEXT:    [[TMP45:%.*]] = getelementptr i8, ptr [[NEXT_GEP10]], i64 8
; CHECK-NEXT:    [[TMP46:%.*]] = getelementptr i8, ptr [[NEXT_GEP11]], i64 8
; CHECK-NEXT:    [[TMP47:%.*]] = getelementptr i8, ptr [[NEXT_GEP12]], i64 8
; CHECK-NEXT:    [[TMP48:%.*]] = getelementptr i8, ptr [[NEXT_GEP13]], i64 8
; CHECK-NEXT:    [[TMP49:%.*]] = getelementptr i8, ptr [[NEXT_GEP14]], i64 8
; CHECK-NEXT:    [[TMP50:%.*]] = getelementptr i8, ptr [[NEXT_GEP15]], i64 8
; CHECK-NEXT:    [[TMP51:%.*]] = getelementptr i8, ptr [[NEXT_GEP16]], i64 8
; CHECK-NEXT:    [[TMP52:%.*]] = getelementptr i8, ptr [[NEXT_GEP17]], i64 8
; CHECK-NEXT:    [[TMP53:%.*]] = getelementptr i8, ptr [[NEXT_GEP18]], i64 8
; CHECK-NEXT:    [[TMP54:%.*]] = getelementptr i8, ptr [[NEXT_GEP19]], i64 8
; CHECK-NEXT:    [[TMP55:%.*]] = getelementptr i8, ptr [[NEXT_GEP20]], i64 8
; CHECK-NEXT:    [[TMP56:%.*]] = getelementptr i8, ptr [[NEXT_GEP21]], i64 8
; CHECK-NEXT:    [[TMP57:%.*]] = getelementptr i8, ptr [[NEXT_GEP22]], i64 8
; CHECK-NEXT:    [[TMP58:%.*]] = getelementptr i8, ptr [[NEXT_GEP23]], i64 8
; CHECK-NEXT:    [[TMP59:%.*]] = getelementptr i8, ptr [[NEXT_GEP24]], i64 8
; CHECK-NEXT:    [[TMP60:%.*]] = getelementptr i8, ptr [[NEXT_GEP25]], i64 8
; CHECK-NEXT:    [[TMP61:%.*]] = getelementptr i8, ptr [[NEXT_GEP26]], i64 8
; CHECK-NEXT:    [[TMP62:%.*]] = getelementptr i8, ptr [[NEXT_GEP27]], i64 8
; CHECK-NEXT:    [[TMP63:%.*]] = getelementptr i8, ptr [[NEXT_GEP28]], i64 8
; CHECK-NEXT:    [[TMP64:%.*]] = getelementptr i8, ptr [[NEXT_GEP29]], i64 8
; CHECK-NEXT:    [[TMP65:%.*]] = getelementptr i8, ptr [[NEXT_GEP30]], i64 8
; CHECK-NEXT:    [[TMP66:%.*]] = getelementptr i8, ptr [[NEXT_GEP31]], i64 8
; CHECK-NEXT:    [[TMP67:%.*]] = getelementptr i8, ptr [[NEXT_GEP32]], i64 8
; CHECK-NEXT:    [[TMP68:%.*]] = getelementptr i8, ptr [[NEXT_GEP33]], i64 8
; CHECK-NEXT:    [[TMP69:%.*]] = getelementptr i8, ptr [[NEXT_GEP34]], i64 8
; CHECK-NEXT:    [[TMP70:%.*]] = getelementptr i8, ptr [[NEXT_GEP35]], i64 8
; CHECK-NEXT:    [[TMP71:%.*]] = load ptr, ptr [[TMP39]], align 8
; CHECK-NEXT:    [[TMP72:%.*]] = load ptr, ptr [[TMP40]], align 8
; CHECK-NEXT:    [[TMP73:%.*]] = load ptr, ptr [[TMP41]], align 8
; CHECK-NEXT:    [[TMP74:%.*]] = load ptr, ptr [[TMP42]], align 8
; CHECK-NEXT:    [[TMP75:%.*]] = load ptr, ptr [[TMP43]], align 8
; CHECK-NEXT:    [[TMP76:%.*]] = load ptr, ptr [[TMP44]], align 8
; CHECK-NEXT:    [[TMP77:%.*]] = load ptr, ptr [[TMP45]], align 8
; CHECK-NEXT:    [[TMP78:%.*]] = load ptr, ptr [[TMP46]], align 8
; CHECK-NEXT:    [[TMP79:%.*]] = load ptr, ptr [[TMP47]], align 8
; CHECK-NEXT:    [[TMP80:%.*]] = load ptr, ptr [[TMP48]], align 8
; CHECK-NEXT:    [[TMP81:%.*]] = load ptr, ptr [[TMP49]], align 8
; CHECK-NEXT:    [[TMP82:%.*]] = load ptr, ptr [[TMP50]], align 8
; CHECK-NEXT:    [[TMP83:%.*]] = load ptr, ptr [[TMP51]], align 8
; CHECK-NEXT:    [[TMP84:%.*]] = load ptr, ptr [[TMP52]], align 8
; CHECK-NEXT:    [[TMP85:%.*]] = load ptr, ptr [[TMP53]], align 8
; CHECK-NEXT:    [[TMP86:%.*]] = load ptr, ptr [[TMP54]], align 8
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <16 x ptr> poison, ptr [[TMP71]], i32 0
; CHECK-NEXT:    [[TMP88:%.*]] = insertelement <16 x ptr> [[TMP87]], ptr [[TMP72]], i32 1
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <16 x ptr> [[TMP88]], ptr [[TMP73]], i32 2
; CHECK-NEXT:    [[TMP90:%.*]] = insertelement <16 x ptr> [[TMP89]], ptr [[TMP74]], i32 3
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <16 x ptr> [[TMP90]], ptr [[TMP75]], i32 4
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <16 x ptr> [[TMP91]], ptr [[TMP76]], i32 5
; CHECK-NEXT:    [[TMP93:%.*]] = insertelement <16 x ptr> [[TMP92]], ptr [[TMP77]], i32 6
; CHECK-NEXT:    [[TMP94:%.*]] = insertelement <16 x ptr> [[TMP93]], ptr [[TMP78]], i32 7
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <16 x ptr> [[TMP94]], ptr [[TMP79]], i32 8
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <16 x ptr> [[TMP95]], ptr [[TMP80]], i32 9
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <16 x ptr> [[TMP96]], ptr [[TMP81]], i32 10
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <16 x ptr> [[TMP97]], ptr [[TMP82]], i32 11
; CHECK-NEXT:    [[TMP99:%.*]] = insertelement <16 x ptr> [[TMP98]], ptr [[TMP83]], i32 12
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <16 x ptr> [[TMP99]], ptr [[TMP84]], i32 13
; CHECK-NEXT:    [[TMP101:%.*]] = insertelement <16 x ptr> [[TMP100]], ptr [[TMP85]], i32 14
; CHECK-NEXT:    [[TMP102:%.*]] = insertelement <16 x ptr> [[TMP101]], ptr [[TMP86]], i32 15
; CHECK-NEXT:    [[TMP103:%.*]] = load ptr, ptr [[TMP55]], align 8
; CHECK-NEXT:    [[TMP104:%.*]] = load ptr, ptr [[TMP56]], align 8
; CHECK-NEXT:    [[TMP105:%.*]] = load ptr, ptr [[TMP57]], align 8
; CHECK-NEXT:    [[TMP106:%.*]] = load ptr, ptr [[TMP58]], align 8
; CHECK-NEXT:    [[TMP107:%.*]] = load ptr, ptr [[TMP59]], align 8
; CHECK-NEXT:    [[TMP108:%.*]] = load ptr, ptr [[TMP60]], align 8
; CHECK-NEXT:    [[TMP109:%.*]] = load ptr, ptr [[TMP61]], align 8
; CHECK-NEXT:    [[TMP110:%.*]] = load ptr, ptr [[TMP62]], align 8
; CHECK-NEXT:    [[TMP111:%.*]] = load ptr, ptr [[TMP63]], align 8
; CHECK-NEXT:    [[TMP112:%.*]] = load ptr, ptr [[TMP64]], align 8
; CHECK-NEXT:    [[TMP113:%.*]] = load ptr, ptr [[TMP65]], align 8
; CHECK-NEXT:    [[TMP114:%.*]] = load ptr, ptr [[TMP66]], align 8
; CHECK-NEXT:    [[TMP115:%.*]] = load ptr, ptr [[TMP67]], align 8
; CHECK-NEXT:    [[TMP116:%.*]] = load ptr, ptr [[TMP68]], align 8
; CHECK-NEXT:    [[TMP117:%.*]] = load ptr, ptr [[TMP69]], align 8
; CHECK-NEXT:    [[TMP118:%.*]] = load ptr, ptr [[TMP70]], align 8
; CHECK-NEXT:    [[TMP119:%.*]] = insertelement <16 x ptr> poison, ptr [[TMP103]], i32 0
; CHECK-NEXT:    [[TMP120:%.*]] = insertelement <16 x ptr> [[TMP119]], ptr [[TMP104]], i32 1
; CHECK-NEXT:    [[TMP121:%.*]] = insertelement <16 x ptr> [[TMP120]], ptr [[TMP105]], i32 2
; CHECK-NEXT:    [[TMP122:%.*]] = insertelement <16 x ptr> [[TMP121]], ptr [[TMP106]], i32 3
; CHECK-NEXT:    [[TMP123:%.*]] = insertelement <16 x ptr> [[TMP122]], ptr [[TMP107]], i32 4
; CHECK-NEXT:    [[TMP124:%.*]] = insertelement <16 x ptr> [[TMP123]], ptr [[TMP108]], i32 5
; CHECK-NEXT:    [[TMP125:%.*]] = insertelement <16 x ptr> [[TMP124]], ptr [[TMP109]], i32 6
; CHECK-NEXT:    [[TMP126:%.*]] = insertelement <16 x ptr> [[TMP125]], ptr [[TMP110]], i32 7
; CHECK-NEXT:    [[TMP127:%.*]] = insertelement <16 x ptr> [[TMP126]], ptr [[TMP111]], i32 8
; CHECK-NEXT:    [[TMP128:%.*]] = insertelement <16 x ptr> [[TMP127]], ptr [[TMP112]], i32 9
; CHECK-NEXT:    [[TMP129:%.*]] = insertelement <16 x ptr> [[TMP128]], ptr [[TMP113]], i32 10
; CHECK-NEXT:    [[TMP130:%.*]] = insertelement <16 x ptr> [[TMP129]], ptr [[TMP114]], i32 11
; CHECK-NEXT:    [[TMP131:%.*]] = insertelement <16 x ptr> [[TMP130]], ptr [[TMP115]], i32 12
; CHECK-NEXT:    [[TMP132:%.*]] = insertelement <16 x ptr> [[TMP131]], ptr [[TMP116]], i32 13
; CHECK-NEXT:    [[TMP133:%.*]] = insertelement <16 x ptr> [[TMP132]], ptr [[TMP117]], i32 14
; CHECK-NEXT:    [[TMP134:%.*]] = insertelement <16 x ptr> [[TMP133]], ptr [[TMP118]], i32 15
; CHECK-NEXT:    [[TMP135:%.*]] = icmp ne <16 x ptr> [[TMP102]], splat (ptr null)
; CHECK-NEXT:    [[TMP136:%.*]] = icmp ne <16 x ptr> [[TMP134]], splat (ptr null)
; CHECK-NEXT:    [[TMP137]] = or <16 x i1> [[VEC_PHI]], [[TMP135]]
; CHECK-NEXT:    [[TMP138]] = or <16 x i1> [[VEC_PHI4]], [[TMP136]]
; CHECK-NEXT:    [[INDEX_NEXT1]] = add nuw i64 [[INDEX1]], 32
; CHECK-NEXT:    [[TMP139:%.*]] = icmp eq i64 [[INDEX_NEXT1]], [[N_VEC1]]
; CHECK-NEXT:    br i1 [[TMP139]], label %[[MIDDLE_BLOCK1:.*]], label %[[VECTOR_BODY1]], !llvm.loop [[LOOP16:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK1]]:
; CHECK-NEXT:    [[BIN_RDX:%.*]] = or <16 x i1> [[TMP138]], [[TMP137]]
; CHECK-NEXT:    [[TMP140:%.*]] = call i1 @llvm.vector.reduce.or.v16i1(<16 x i1> [[BIN_RDX]])
; CHECK-NEXT:    [[TMP141:%.*]] = freeze i1 [[TMP140]]
; CHECK-NEXT:    br label %[[VEC_EPILOG_ITER_CHECK:.*]]
; CHECK:       [[VEC_EPILOG_ITER_CHECK]]:
; CHECK-NEXT:    [[MIN_EPILOG_ITERS_CHECK:%.*]] = icmp ule i64 [[TMP144]], 4
; CHECK-NEXT:    br i1 [[MIN_EPILOG_ITERS_CHECK]], label %[[SCALAR_PH]], label %[[VEC_EPILOG_PH]], !prof [[PROF17:![0-9]+]]
; CHECK:       [[VEC_EPILOG_PH]]:
; CHECK-NEXT:    [[VEC_EPILOG_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC1]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_PH]] ]
; CHECK-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i1 [ [[TMP141]], %[[VEC_EPILOG_ITER_CHECK]] ], [ false, %[[VECTOR_PH]] ]
; CHECK-NEXT:    [[TMP142:%.*]] = icmp ne i1 [[BC_MERGE_RDX]], false
...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <4 x i1> poison, i1 [[TMP142]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <4 x i1> [[BROADCAST_SPLATINSERT]], <4 x i1> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], %[[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI39:%.*]] = phi <4 x i1> [ [[BROADCAST_SPLAT]], %[[VEC_EPILOG_PH]] ], [ [[TMP164:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP159:%.*]] = insertelement <4 x ptr> poison, ptr [[TMP15]], i32 0
; CHECK-NEXT:    [[TMP160:%.*]] = insertelement <4 x ptr> [[TMP159]], ptr [[TMP16]], i32 1
; CHECK-NEXT:    [[TMP161:%.*]] = insertelement <4 x ptr> [[TMP160]], ptr [[TMP19]], i32 2
; CHECK-NEXT:    [[TMP162:%.*]] = insertelement <4 x ptr> [[TMP161]], ptr [[TMP20]], i32 3
; CHECK-NEXT:    [[TMP163:%.*]] = icmp ne <4 x ptr> [[TMP162]], splat (ptr null)
; CHECK-NEXT:    [[TMP164]] = or <4 x i1> [[VEC_PHI39]], [[TMP163]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; CHECK-NEXT:    [[TMP27:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP27]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[TMP28:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP164]])
