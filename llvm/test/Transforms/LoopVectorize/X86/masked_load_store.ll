...
; AVX512-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <16 x i32> @llvm.masked.gather.v16i32.v16p0(<16 x ptr> align 4 [[TMP0]], <16 x i1> splat (i1 true), <16 x i32> poison), !alias.scope [[META24:![0-9]+]]
...
; AVX512-NEXT:    [[WIDE_MASKED_GATHER6:%.*]] = call <16 x double> @llvm.masked.gather.v16f64.v16p0(<16 x ptr> align 8 [[TMP3]], <16 x i1> [[TMP1]], <16 x double> poison), !alias.scope [[META27:![0-9]+]]
...
; AVX512-NEXT:    call void @llvm.masked.scatter.v16f64.v16p0(<16 x double> [[TMP5]], <16 x ptr> align 8 [[TMP6]], <16 x i1> [[TMP1]]), !alias.scope [[META29:![0-9]+]], !noalias [[META31:![0-9]+]]
...
; AVX1-NEXT:    [[WIDE_LOAD:%.*]] = load <16 x i8>, ptr [[TMP0]], align 1
; AVX1-NEXT:    [[TMP1:%.*]] = and <16 x i8> [[WIDE_LOAD]], splat (i8 1)
; AVX1-NEXT:    [[TMP2:%.*]] = icmp ne <16 x i8> [[TMP1]], zeroinitializer
; AVX1-NEXT:    [[TMP12:%.*]] = getelementptr ptr, ptr [[IN]], i64 [[INDEX]]
; AVX1-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <16 x ptr> @llvm.masked.load.v16p0.p0(ptr align 8 [[TMP12]], <16 x i1> [[TMP2]], <16 x ptr> poison)
; AVX1-NEXT:    [[TMP4:%.*]] = icmp ne <16 x ptr> [[WIDE_MASKED_LOAD]], splat (ptr null)
; AVX1-NEXT:    [[TMP5:%.*]] = select <16 x i1> [[TMP2]], <16 x i1> [[TMP4]], <16 x i1> zeroinitializer
; AVX1-NEXT:    [[TMP24:%.*]] = getelementptr double, ptr [[OUT]], i64 [[INDEX]]
; AVX1-NEXT:    call void @llvm.masked.store.v16f64.p0(<16 x double> splat (double 5.000000e-01), ptr align 8 [[TMP24]], <16 x i1> [[TMP5]])
; AVX1-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 16
...
; AVX2-NEXT:    [[TMP1:%.*]] = and <32 x i8> [[WIDE_LOAD]], splat (i8 1)
; AVX2-NEXT:    [[TMP2:%.*]] = icmp ne <32 x i8> [[TMP1]], zeroinitializer
; AVX2-NEXT:    [[TMP12:%.*]] = getelementptr ptr, ptr [[IN]], i64 [[INDEX]]
; AVX2-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <32 x ptr> @llvm.masked.load.v32p0.p0(ptr align 8 [[TMP12]], <32 x i1> [[TMP2]], <32 x ptr> poison)
; AVX2-NEXT:    [[TMP4:%.*]] = icmp ne <32 x ptr> [[WIDE_MASKED_LOAD]], splat (ptr null)
; AVX2-NEXT:    [[TMP5:%.*]] = select <32 x i1> [[TMP2]], <32 x i1> [[TMP4]], <32 x i1> zeroinitializer
; AVX2-NEXT:    [[TMP24:%.*]] = getelementptr double, ptr [[OUT]], i64 [[INDEX]]
; AVX2-NEXT:    call void @llvm.masked.store.v32f64.p0(<32 x double> splat (double 5.000000e-01), ptr align 8 [[TMP24]], <32 x i1> [[TMP5]])
; AVX2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 32
...
; AVX512-NEXT:    [[TMP1:%.*]] = and <64 x i8> [[WIDE_LOAD]], splat (i8 1)
; AVX512-NEXT:    [[TMP2:%.*]] = icmp ne <64 x i8> [[TMP1]], zeroinitializer
; AVX512-NEXT:    [[TMP12:%.*]] = getelementptr ptr, ptr [[IN]], i64 [[INDEX]]
; AVX512-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <64 x ptr> @llvm.masked.load.v64p0.p0(ptr align 8 [[TMP12]], <64 x i1> [[TMP2]], <64 x ptr> poison)
; AVX512-NEXT:    [[TMP4:%.*]] = icmp ne <64 x ptr> [[WIDE_MASKED_LOAD]], splat (ptr null)
; AVX512-NEXT:    [[TMP5:%.*]] = select <64 x i1> [[TMP2]], <64 x i1> [[TMP4]], <64 x i1> zeroinitializer
; AVX512-NEXT:    [[TMP24:%.*]] = getelementptr double, ptr [[OUT]], i64 [[INDEX]]
; AVX512-NEXT:    call void @llvm.masked.store.v64f64.p0(<64 x double> splat (double 5.000000e-01), ptr align 8 [[TMP24]], <64 x i1> [[TMP5]])
; AVX512-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 64
...
; AVX2-NEXT:    [[TMP232:%.*]] = insertelement <8 x i32> poison, i32 [[TMP64]], i32 0
; AVX2-NEXT:    [[TMP137:%.*]] = insertelement <8 x i32> [[TMP232]], i32 [[TMP65]], i32 1
; AVX2-NEXT:    [[TMP138:%.*]] = insertelement <8 x i32> [[TMP137]], i32 [[TMP66]], i32 2
; AVX2-NEXT:    [[TMP139:%.*]] = insertelement <8 x i32> [[TMP138]], i32 [[TMP67]], i32 3
; AVX2-NEXT:    [[TMP140:%.*]] = insertelement <8 x i32> [[TMP139]], i32 [[TMP72]], i32 4
; AVX2-NEXT:    [[TMP141:%.*]] = insertelement <8 x i32> [[TMP140]], i32 [[TMP73]], i32 5
; AVX2-NEXT:    [[TMP142:%.*]] = insertelement <8 x i32> [[TMP141]], i32 [[TMP74]], i32 6
; AVX2-NEXT:    [[TMP143:%.*]] = insertelement <8 x i32> [[TMP142]], i32 [[TMP75]], i32 7
...
; AVX2-NEXT:    [[TMP152:%.*]] = insertelement <8 x i32> poison, i32 [[TMP80]], i32 0
; AVX2-NEXT:    [[TMP153:%.*]] = insertelement <8 x i32> [[TMP152]], i32 [[TMP81]], i32 1
; AVX2-NEXT:    [[TMP154:%.*]] = insertelement <8 x i32> [[TMP153]], i32 [[TMP82]], i32 2
; AVX2-NEXT:    [[TMP155:%.*]] = insertelement <8 x i32> [[TMP154]], i32 [[TMP83]], i32 3
; AVX2-NEXT:    [[TMP156:%.*]] = insertelement <8 x i32> [[TMP155]], i32 [[TMP88]], i32 4
; AVX2-NEXT:    [[TMP157:%.*]] = insertelement <8 x i32> [[TMP156]], i32 [[TMP89]], i32 5
; AVX2-NEXT:    [[TMP158:%.*]] = insertelement <8 x i32> [[TMP157]], i32 [[TMP90]], i32 6
; AVX2-NEXT:    [[TMP159:%.*]] = insertelement <8 x i32> [[TMP158]], i32 [[TMP91]], i32 7
...
; AVX2-NEXT:    [[TMP168:%.*]] = insertelement <8 x i32> poison, i32 [[TMP160]], i32 0
; AVX2-NEXT:    [[TMP169:%.*]] = insertelement <8 x i32> [[TMP168]], i32 [[TMP161]], i32 1
; AVX2-NEXT:    [[TMP170:%.*]] = insertelement <8 x i32> [[TMP169]], i32 [[TMP162]], i32 2
; AVX2-NEXT:    [[TMP171:%.*]] = insertelement <8 x i32> [[TMP170]], i32 [[TMP163]], i32 3
; AVX2-NEXT:    [[TMP172:%.*]] = insertelement <8 x i32> [[TMP171]], i32 [[TMP164]], i32 4
; AVX2-NEXT:    [[TMP173:%.*]] = insertelement <8 x i32> [[TMP172]], i32 [[TMP165]], i32 5
; AVX2-NEXT:    [[TMP174:%.*]] = insertelement <8 x i32> [[TMP173]], i32 [[TMP166]], i32 6
; AVX2-NEXT:    [[TMP175:%.*]] = insertelement <8 x i32> [[TMP174]], i32 [[TMP167]], i32 7
...
; AVX2-NEXT:    [[TMP184:%.*]] = insertelement <8 x i32> poison, i32 [[TMP176]], i32 0
; AVX2-NEXT:    [[TMP185:%.*]] = insertelement <8 x i32> [[TMP184]], i32 [[TMP177]], i32 1
; AVX2-NEXT:    [[TMP186:%.*]] = insertelement <8 x i32> [[TMP185]], i32 [[TMP178]], i32 2
; AVX2-NEXT:    [[TMP187:%.*]] = insertelement <8 x i32> [[TMP186]], i32 [[TMP179]], i32 3
; AVX2-NEXT:    [[TMP188:%.*]] = insertelement <8 x i32> [[TMP187]], i32 [[TMP180]], i32 4
; AVX2-NEXT:    [[TMP189:%.*]] = insertelement <8 x i32> [[TMP188]], i32 [[TMP181]], i32 5
; AVX2-NEXT:    [[TMP190:%.*]] = insertelement <8 x i32> [[TMP189]], i32 [[TMP182]], i32 6
; AVX2-NEXT:    [[TMP191:%.*]] = insertelement <8 x i32> [[TMP190]], i32 [[TMP183]], i32 7
